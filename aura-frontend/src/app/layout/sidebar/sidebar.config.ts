...
export const SIDEBAR_MENU: SidebarMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'Clientes y Proveedores', icon: 'pi pi-users',   route: '/terceros',       roles: ['SUPER_ADMIN', 'ADMIN'] },
      { label: 'Cajas',                  icon: 'pi pi-desktop', route: '/caja/cajas',     roles: ['SUPER_ADMIN', 'ADMIN'] },
