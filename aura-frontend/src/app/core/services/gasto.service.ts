...
import { CreateGastoDto, GastoModel, GastoTableModel } from '../models/gasto.model';
...
export class GastoService {
  ...
  page(body: PageableBody): Observable<ResponseTableModel<GastoTableModel>> {
    return this.http.post<ResponseTableModel<GastoTableModel>>(`${this.apiUrl}/page`, body);
  }
  ...
  update(id: number, dto: CreateGastoDto): Observable<ResponseModel<GastoModel>> {
    return this.http.put<ResponseModel<GastoModel>>(`${this.apiUrl}/${id}`, dto);
  }
